...
urlpatterns=[
    ...
    path('group-chat/paginated-messages/<int:chat_pk>/<str:before_id>/',
         views.get_paginated_group_chat_messages, name='get_group_chat_messages_before_id_given'),
    path('private-chat/paginated-messages/<int:chat_pk>/',
         views.get_paginated_private_chat_messages, name='get_private_chat_messages'),
    path('private-chat/paginated-messages/<int:chat_pk>/<str:before_id>/',
         views.get_paginated_private_chat_messages, name='get_private_chat_messages_before_id_given'),
]